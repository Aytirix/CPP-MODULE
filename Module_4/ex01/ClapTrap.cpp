...
void ClapTrap::takeDamage(unsigned int amount)
{
	if (CheckConsumer())
	{
		...
		std::cout << "ClapTrap " << name << " takes " << amount << " points of damage! Current life: " << LifePoints << std::endl;
	}
}
...
void ClapTrap::beRepaired(unsigned int amount)
{
	if (CheckConsumer())
	{
		EnergyPoints--;
		LifePoints += amount;
		std::cout << "ClapTrap " << name << " is repaired for " << amount << " points! Current life: " << LifePoints << std::endl;
	}
}
